...
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=instancesets,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=instancesets/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=instancesets/finalizers,verbs=update
