...
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=configconstraints,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=configconstraints/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=configconstraints/finalizers,verbs=update
...
func (r *ConfigConstraintReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&duanhui8v1.ConfigConstraint{}).
		Complete(r)
}
