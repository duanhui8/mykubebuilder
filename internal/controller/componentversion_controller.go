...
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=componentversions,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=componentversions/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=componentversions/finalizers,verbs=update
...
func (r *ComponentVersionReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&duanhui8v1.ComponentVersion{}).
		Complete(r)
}
