...
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=opsrequests,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=opsrequests/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=opsrequests/finalizers,verbs=update
