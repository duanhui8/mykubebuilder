...
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=servicedescriptors,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=servicedescriptors/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=duanhui8.duangh,resources=servicedescriptors/finalizers,verbs=update
...
func (r *ServiceDescriptorReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&duanhui8v1.ServiceDescriptor{}).
		Complete(r)
}
